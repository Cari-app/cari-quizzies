...
export const componentPalette = {
  form: [
    ...
    { type: 'textarea', name: 'Textarea', icon: 'AlignLeft' },
  ...
  quiz: [
    ...
    { type: 'multiple', name: 'Múltipla Escolha', icon: 'CheckSquare' },
    { type: 'single', name: 'Escolha Única', icon: 'CircleDot' },
  ],
  media: [
  ...
  attention: [
    { type: 'alert', name: 'Alerta', icon: 'TriangleAlert' },
    { type: 'notification', name: 'Notificação', icon: 'Bell' },
    { type: 'timer', name: 'Timer', icon: 'Clock' },
    { type: 'loading', name: 'Loading', icon: 'Loader' },
    { type: 'level', name: 'Nível', icon: 'BarChart3' },
  ],
  argumentation: [
    { type: 'arguments', name: 'Argumentos', icon: 'MessageSquare' },
    { type: 'testimonials', name: 'Depoimentos', icon: 'Users' },
    { type: 'faq', name: 'FAQ', icon: 'HelpCircle' },
    { type: 'price', name: 'Preço', icon: 'Tag' },
    { type: 'before-after', name: 'Antes/Depois', icon: 'ArrowLeftRight' },
    { type: 'carousel', name: 'Carrossel', icon: 'GalleryHorizontal' },
  ],
  charts: [
    { type: 'metrics', name: 'Métricas', icon: 'TrendingUp' },
    { type: 'charts', name: 'Gráficos', icon: 'PieChart' },
  ],
  customization: [
    { type: 'spacer', name: 'Espaço', icon: 'MoveVertical' },
