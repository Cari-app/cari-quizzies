...
export function ComponentEditor({ component, onUpdate, onUpdateCustomId, onDelete, themeColor = '#000000' }: ComponentEditorProps) {
  ...
  // renderInputComponentTab, renderHeightWeightComponentTab, renderButtonComponentTab,
  // renderOptionsComponentTab, renderTextComponentTab have been extracted to ./editors/
